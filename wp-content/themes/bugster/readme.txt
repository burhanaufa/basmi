...
Please install and activate it before starting to use the theme Bugster.
...
Theme documentation is available on http://bugster.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Bugster is Fontello.
