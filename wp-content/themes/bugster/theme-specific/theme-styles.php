...
if ( ! function_exists( 'bugster_customizer_get_css' ) ) {

	function bugster_customizer_get_css( $args = array() ) {
		...
		if ( $fonts ) {
			...
			$fonts = bugster_customizer_add_theme_fonts( $fonts );
...
.bugster_tabs .bugster_tabs_titles li a {
...
.bugster_widget_video .trx_addons_video_player.with_cover .video_hover:after,
.bugster_widget_video_simple .trx_addons_video_player.with_cover .video_hover:after,
...
.top_panel .sc_icons .sc_icons_item_title,
.top_panel .sc_icons_default .sc_icons_item_description,
...
CSS;
			$rez          = apply_filters( 'bugster_filter_get_css', $rez, array( 'fonts' => $fonts ) );
			$css['fonts'] = $rez['fonts'];
		}
		...
		//---------------------------------------------
		if ( null === $vars ) {
			$vars = bugster_get_theme_vars();
		}

		if ( $vars ) {

			// Make theme-specific fonts rules
			$vars = bugster_customizer_add_theme_vars( $vars );
			extract( $vars );
...
CSS;
			$rez          = apply_filters( 'bugster_filter_get_css', $rez, array( 'vars' => $vars ) );
			$css['vars']  = $rez['vars'];
		}
		...
		//--------------------------------------
		if ( false !== $colors ) {
			$schemes = empty( $scheme ) ? array_keys( bugster_get_sorted_schemes() ) : array( $scheme );
			...
			if ( count( $schemes ) > 0 ) {
				...
				foreach ( $schemes as $s ) {
					// Prepare colors
					if ( empty( $scheme ) ) {
						$colors = bugster_get_scheme_colors( $s );
					}
...
.sc_table_price table th, .sc_table_price table th + th, .sc_table_price table td + th  {
...
.sc_table_price table > tbody > tr:nth-child(2n+1) > td {
	background-color: {$colors['alter_bd_color']};
}
table > tbody > tr:nth-child(2n) > td {
	background-color: {$colors['alter_bg_hover']};
}
.sc_table_price table > tbody > tr:nth-child(2n) > td {
	background-color: {$colors['alter_bd_color']};
}
table th a:hover {
	color: {$colors['extra_dark']};
...
select[placeholder]::-webkit-input-placeholder	{ color: {$colors['text_light']}; }
input[placeholder]::-moz-placeholder,
textarea[placeholder]::-moz-placeholder,
select[placeholder]::-moz-placeholder					{ color: {$colors['text_light']}; }
input[placeholder]:-ms-input-placeholder,
textarea[placeholder]:-ms-input-placeholder,
select[placeholder]:-ms-input-placeholder			{ color: {$colors['text_light']}; }
input[placeholder]::placeholder,
textarea[placeholder]::placeholder,
select[placeholder]::placeholder					{ color: {$colors['text_light']}; }

input:hover[placeholder]::-webkit-input-placeholder,
input:focus[placeholder]::-webkit-input-placeholder,
select:hover[placeholder]::-webkit-input-placeholder,
textarea:hover[placeholder]::-webkit-input-placeholder,
textarea:focus[placeholder]::-webkit-input-placeholder,
select:hover[placeholder]::-webkit-input-placeholder	{ color: {$colors['text_link2']}; }
input:hover[placeholder]::-moz-placeholder,
input:focus[placeholder]::-moz-placeholder,
textarea:hover[placeholder]::-moz-placeholder,
textarea:focus[placeholder]::-moz-placeholder				{ color: {$colors['text_link2']}; }
input:hover[placeholder]:-ms-input-placeholder,
input:focus[placeholder]:-ms-input-placeholder,
textarea:hover[placeholder]:-ms-input-placeholder,
textarea:focus[placeholder]:-ms-input-placeholder			{ color: {$colors['text_link2']}; }
input:hover[placeholder]::placeholder,
input:focus[placeholder]::placeholder,
textarea:hover[placeholder]::placeholder,
textarea:focus[placeholder]::placeholder					{ color: {$colors['text_link2']}; }

.search_wrap.search_style_normal input[placeholder]::-webkit-input-placeholder { color: {$colors['text']}; opacity: 1; }
.search_wrap.search_style_normal input[placeholder]::-moz-placeholder { color: {$colors['text']}; opacity: 1; }
.search_wrap.search_style_normal input[placeholder]:-ms-input-placeholder { color: {$colors['text']}; opacity: 1; }
.search_wrap.search_style_normal input[placeholder]::placeholder { color: {$colors['text']}; opacity: 1; }

.bugster_form_row_intro input[placeholder]::-webkit-input-placeholder { opacity: 1; }
...
.comments_field label a {
	color: {$colors['text_link']};
}
.comments_field label a:hover {
	color: {$colors['text_dark']};
}
...
#powerTip.s:before {
	border-bottom-color: {$colors['extra_dark']};
}
#powerTip.n:before {
	border-top-color: {$colors['extra_dark']};
}
#powerTip.w:before {
	border-left-color: {$colors['extra_dark']};
}
#powerTip.e:before {
	border-right-color: {$colors['extra_dark']};
}
...
.sc_services_list .sc_button.sc_button_hover_slide_left {
	color: {$colors['extra_dark']}!important;
}
.theme_button {
...
.sc_layouts_row_type_normal .sc_layouts_item_link:hover .sc_layouts_item_icon {
	color: {$colors['text_link']}!important;
}
...
.footer_wrap .sc_layouts_row_type_normal .sc_layouts_item a:not(.sc_button):not(.button),
.footer_wrap .scheme_self.sc_layouts_row_type_normal .sc_layouts_item a:not(.sc_button):not(.button) {
	color: {$colors['text_dark']};
}
...
.footer_wrap .sc_layouts_row_type_normal a:hover {
	border-color: {$colors['text_link']};
}
...
.sc_layouts_row_type_normal .search_wrap.search_style_fullscreen .search_submit:hover:before,
.scheme_self.sc_layouts_row_type_normal .search_wrap.search_style_fullscreen .search_submit:hover:before {
	background-color: transparent;
	color: {$colors['text_link']};
}
...
.top_panel_default .sc_layouts_title a.post_meta_item:hover,
...
.top_panel_default .sc_layouts_menu_nav > li > a:hover,
...
.bugster_tabs .bugster_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.bugster_tabs .bugster_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.sheme_self.sidebar .bugster_tabs .bugster_tabs_titles li.ui-state-active a {
...
.post_item_single .sc_blogger .post_header .post_meta_item.post_categories a {
	color: {$colors['text_dark']}!important;
	background-color: {$colors['text_link']};
}
.post_item_single .sc_blogger .post_meta_item.post_share .socials_caption:hover {
	color: {$colors['text_link']}!important;
}
.post_meta_item.post_categories a:hover,
.post_item_single .sc_blogger .post_header .post_meta_item.post_categories a:hover {
	color: {$colors['extra_dark']}!important;
	background-color: {$colors['text_dark']};
}
...
.post_item_single .post_meta_item.post_share .socials_wrap .social_item:hover .social_icon {
	color: {$colors['text_dark']};
	background-color: {$colors['extra_dark']};
}
...
.bugster_widget_video .trx_addons_video_player.with_cover .video_hover,
.bugster_widget_video_simple .trx_addons_video_player.with_cover .video_hover {
	color: {$colors['extra_dark']};
	background-color: {$colors['text_dark']};
}
.bugster_widget_video .trx_addons_video_player.with_cover .video_hover:hover,
.bugster_widget_video_simple .trx_addons_video_player.with_cover .video_hover:hover {
	color: {$colors['text_dark']};
	background-color: {$colors['text_link']};
}
...
.bugster_widget_video .sc_widget_video .trx_addons_video_player.with_cover .video_hover:before,
.bugster_widget_video_simple .sc_widget_video .trx_addons_video_player.with_cover .video_hover:before {
	color: {$colors['text_dark']};
	background-color: {$colors['text_link']};
}
.bugster_widget_video .sc_widget_video .trx_addons_video_player.with_cover .video_hover:hover:before,
.bugster_widget_video_simple .sc_widget_video .trx_addons_video_player.with_cover .video_hover:hover:before {
	color: {$colors['extra_dark']};
	background-color: {$colors['text_dark']};
}
...
CSS;
					...
					$rez            = apply_filters(
						'bugster_filter_get_css', $rez, array(
							'colors' => $colors,
							'scheme' => $s,
						)
					);
		...
		return apply_filters( 'bugster_filter_prepare_css', $css_str, $remove_spaces );
	}
}
