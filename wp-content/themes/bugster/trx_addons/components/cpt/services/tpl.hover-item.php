...
?>>
	...
	if (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0) {
		?><div class="sc_services_item_content"<?php if (!empty($image))?>>
			...
			<div class="sc_services_item_content_inner">
                ...
                <?php
                if (!empty($link)) {
				    ?><a class="sc_services_item_link" href="<?php echo esc_url($link); ?>"<?php if (!empty($meta['link'])) echo ' target="_blank"'; ?>><?php esc_attr_e('Learn More', 'bugster'); ?></a><?php
                }
                ?>
			</div><?php
