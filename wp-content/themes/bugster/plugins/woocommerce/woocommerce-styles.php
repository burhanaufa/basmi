...
if ( ! function_exists( 'bugster_woocommerce_get_css' ) ) {
	add_filter( 'bugster_filter_get_css', 'bugster_woocommerce_get_css', 10, 2 );
	function bugster_woocommerce_get_css( $css, $args ) {
...
.woocommerce-page .widget_shopping_cart span.amount {
...
/* Shop mode selector */
.bugster_shop_mode_buttons a {
	color: {$colors['input_light']};
}
.bugster_shop_mode_buttons a:hover {
	color: {$colors['text_hover']};
}
.shop_mode_thumbs .bugster_shop_mode_buttons a.woocommerce_thumbs,
.shop_mode_list .bugster_shop_mode_buttons a.woocommerce_list {
	color: {$colors['text_dark']};
}
