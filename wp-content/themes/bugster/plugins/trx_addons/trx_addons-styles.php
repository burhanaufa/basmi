...
if ( ! function_exists( 'bugster_trx_addons_add_theme_vars' ) ) {
	add_filter( 'bugster_filter_add_theme_vars', 'bugster_trx_addons_add_theme_vars', 10, 2 );
	function bugster_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'bugster_trx_addons_get_css' ) ) {
	add_filter( 'bugster_filter_get_css', 'bugster_trx_addons_get_css', 10, 2 );
	function bugster_trx_addons_get_css( $css, $args ) {
...
.sc_action_simple .sc_action_item .sc_action_item_subtitle {						color:{$colors['inverse_text']}; }
.sc_action_simple .sc_action_item .sc_action_item_title a:hover {
	color:{$colors['inverse_text']};
}
...
.top_panel .sc_icons .sc_icons_icon {
	color: {$colors['text_dark']};
}
...
.sc_icons_simple .trx_addons_columns_wrap > [class*="trx_addons_column-"] {
	border-color: {$colors['alter_bg_color']};
}
...
.top_panel .sc_icons_default .sc_icons_item_description a {
	color: {$colors['text_link']}!important;
}
.top_panel .sc_icons_default .sc_icons_item_description a:hover {
...
.sc_services .sc_item_descr a {
	color: {$colors['text_dark']};
	border-color: {$colors['text_link']};
}
.sc_services .sc_item_descr a:hover {
	color: {$colors['text_link']};
}
...
.sc_services_hover .sc_services_item_content .sc_services_item_link:hover {
	color: {$colors['text_link']};
}
...
.sc_services_hover .sc_services_item_header.without_image .sc_services_item_title, 
.sc_services_hover .sc_services_item_header.without_image .sc_services_item_title a {
	color: {$colors['text_dark']}!important;
}
.sc_services_hover .sc_services_item_header .sc_services_item_title, 
.sc_services_hover .sc_services_item_header .sc_services_item_title a {
	color: {$colors['text_link']}!important;
}
...
.sc_services_hover .sc_services_item_pictogram:before {
	background-color:{$colors['bg_color']};
}
